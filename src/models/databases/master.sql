-- ══════════════════════════════════════════════════════════════════════════════
-- master.sql  —  wuxi database schema  (REFERENCE ONLY)
...
ALTER TABLE tb_expense_card
	ADD COLUMN cycle_start_date VARCHAR(10) DEFAULT NULL,
	ADD COLUMN due_date VARCHAR(10) DEFAULT NULL;
