...
// AIG module removed — it was dormant, unused scaffolding for authenticating
// an AI agent via an x-api-key (aig_...) against the Itinerary endpoints;
// never wired up to any frontend.
